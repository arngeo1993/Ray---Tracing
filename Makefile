...
OPTIMIZE = -g -O4
CXXFLAGS = $(OPTIMIZE) -std=c++11 -I$(LIBDIR)/glbinding  -I$(LIBDIR)/freeglut -I$(LIBDIR)/glm -I$(LIBDIR) -I$(LIBDIR)/assimp/include -Wnarrowing -I.  -fopenmp -msse3 -DEIGEN_NO_DEBUG -Wno-deprecated-declarations

LIBS = -L$(LIBDIR) -L/usr/lib -L/usr/local/lib -lassimp -lAntTweakBar -lglbinding -lfreeglut -lX11 -lGLU -lGL
